  ...
  return (
    <div className="max-w-3xl mx-auto px-6 py-16 space-y-12">
      ...
      >
        ...
        dynamically. No need for endless preparation or writing marathons —
        just pure, spontaneous adventures powered by AI.
      </motion.p>
      ...
      <div className="grid gap-6 sm:grid-cols-2">
        ...
        >
          ...
          <p className="text-gray-400 text-sm leading-relaxed">
            Fanfiction, RPG campaigns, and D&D sessions are amazing but can
            also be time-consuming and sometimes feel a little rigid. We
            wanted to create a faster, more playful way to jump into those
            same experiences — without losing the spark of creativity.
          </p>
        </motion.div>
      ...
      <motion.div
        ...
        viewport={{ once: true, amount: 0.4 }}
        whileHover={{ scale: 1.02, boxShadow: "0px 0px 25px rgba(236,72,153,0.4)" }}
        className="p-6 rounded-2xl bg-gradient-to-b from-[#141422] to-[#0f0f1a] border border-[#1e1e2f] cursor-pointer"
      >
        ...
        <p className="text-gray-400 text-sm leading-relaxed">
          ...
          writer, a roleplayer, or a D&D enthusiast, you’ll find our app a
          fun and refreshing way to tell stories with friends — or just for
          yourself.
        </p>
      </motion.div>
